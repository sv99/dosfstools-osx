...
OPTFLAGS = -O2 -fomit-frame-pointer -D_GNU_SOURCE -D_DARWIN_C_SOURCE 
#WARNFLAGS = -Wall -pedantic -std=c99
WARNFLAGS = -Wall -Wextra -Wno-sign-compare -Wno-missing-field-initializers -Wmissing-prototypes -Wstrict-prototypes -Wimplicit-function-declaration
DEBUGFLAGS = -g
CFLAGS += $(OPTFLAGS) $(WARNFLAGS) $(DEBUGFLAGS) -Iinclude
LDFLAGS += -v -liconv
...
install-bin: build
	...
	install -m 0755 fsck.fat mkfs.fat $(DESTDIR)/$(SBINDIR)
